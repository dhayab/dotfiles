...
running "replacing items in .zshrc with your info ($COL_YELLOW$LOGNAME$COL_RESET)"
# test if gnu-sed or MacOS sed
sed -i "s/LOGNAME/$LOGNAME/" ./homedir/.zshrc > /dev/null 2>&1 | true
if [[ ${PIPESTATUS[0]} != 0 ]]; then
  echo
  sed -i '' "s/LOGNAME/$LOGNAME/" ./homedir/.zshrc
  ok
fi
...
running "Set highlight color to orange"
defaults write NSGlobalDomain AppleHighlightColor -string "1.000000 0.874510 0.701961";ok
...
running "Add the keyboard shortcut ⌥ + ⇥ to cycle through the windows of the same application"
defaults write com.apple.symbolichotkeys AppleSymbolicHotKeys -dict-add 27 "{enabled = 1; value={parameters = (65535, 48, 524288); type = 'standard';};}";ok
...
running "Set language and text formats (french/FR)"
...
running "Set Downloads folder as the default location for new Finder windows"
...
running "Enable snap-to-grid and set grid size for icons on the desktop"
/usr/libexec/PlistBuddy -c "Set :DesktopViewSettings:IconViewSettings:arrangeBy grid" ~/Library/Preferences/com.apple.finder.plist
/usr/libexec/PlistBuddy -c "Set :DesktopViewSettings:IconViewSettings:iconSize 64" ~/Library/Preferences/com.apple.finder.plist
/usr/libexec/PlistBuddy -c "Set :DesktopViewSettings:IconViewSettings:gridSpacing 60" ~/Library/Preferences/com.apple.finder.plist;ok
...
defaults write com.apple.dock tilesize -int 64;ok
...
running "Set QLColorCode font options"
defaults write org.n8gray.QLColorCode textEncoding UTF-16
defaults write org.n8gray.QLColorCode webkitTextEncoding UTF-16
defaults write org.n8gray.QLColorCode font "Inconsolata for Powerline"
defaults write org.n8gray.QLColorCode fontSizePoints 10
defaults write org.n8gray.QLColorCode extraHLFlags '-l -W';ok
